...
def run_strategy(binary, trades_path, depth_path, symbol, strategy, quantity_scale):
    command = [
        str(binary),
        "l2_replay",
        str(trades_path),
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="toyquant_l2_bench_") as temp_dir_name:
        ...
        for strategy in strategies:
            ...
            row.update(run_strategy(args.binary, sliced_trades, sliced_depth, args.symbol, strategy, args.quantity_scale))
