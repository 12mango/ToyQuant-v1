...
bool UdpFeed::start()
{
    ...
    set_sock_rcvbuf(sock_, 4);  // Increase the receive buffer to 4 MiB.
...
-------------------------------------------
 ...
 Format: "ts,symbol,price,size,side"

 string_view and find avoid intermediate token allocations.
-------------------------------------------

 Equivalent C-style example for comparison:
